...
//#define PACKET_LIB_ADAPTER_NR         0		//选择网卡的序号,我的笔记本的序号
#define PACKET_LIB_ADAPTER_NR         3		//选择网卡的序号，我的台式机的序号
...
/* #define USE_PCAPIF 1 */
//#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), 192,168,10,200)
//#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), 192,168,10,1)
